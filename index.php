...
while (($file = readdir($dh)) !== false)
{
    if($file != '.' && $file != '..')
    {
        ...
        $origName = $parts[1];
        $file_type = getFileType(substr($file, strlen($file) - 3));
        $uploaded_files .= "<li class=\"$file_type\"><a href=\"$filename\">$origName</a> $size - $added</li>\n";
    }
}
closedir($dh);
...
<head>
    ...
    <title>MyBox, Inc</title>
</head>
<body>
<div id ="creator">MyBox by andresbraga, <a href="https://www.000webhost.com/"> In a 000WebHost Server</a></div>
